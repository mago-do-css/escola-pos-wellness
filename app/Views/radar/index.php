...
<main id="top" class="bg-cream text-ink">
    ...
    <section id="sete-dias" class="py-20 lg:py-32">
        <div class="page-container"><p class="section-kicker">Uma peça por dia</p><h2 class="mt-6 max-w-[12ch] font-display text-[clamp(3rem,5.8vw,5.8rem)] leading-[.92] tracking-[-.05em]">Você não vai tentar explicar tudo de uma vez.</h2>
